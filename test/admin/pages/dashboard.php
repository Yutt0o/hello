          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="col-md-12">
                ...
                <div class="box-header">
                  ...
                  <h3 class="box-title">Horario para el año escolar 2015-2016</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                <table class="table table-bordered">
                  <thead>
                    <tr>
                    <th class="text-center">Grado 1</th>
           <th class = "text-center"> Lunes </th>
                  ...
                  <tbody class="text-center">
                    <tr>
                      <td></td>
                      <td>TLE<br>Sr.Angela Angel<br>Cuarto c4-12</td>
                     ...
                     <tr>
                      <td></td>
                      <td>Filipino<br>Mrs.Brom Brom<br>Cuarto c4-12</td>
                      <td>English<br>Mrs.A B<br>Room c4-9</td>
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                             <th class="text-center">Grado 2</th>
                 <th class = "text-center"> Lunes </th>
                    <th class = "text-center"> Martes </th>
                    <th class = "text-center"> Miercoles </th>
                    <th class = "text-center"> jueves </th>
                  ...
                  <tbody class="text-center">
                    <tr>
                      <td></td>
                      <td>TLE<br>Sra.Angela Angel<br>Room c4-12</td>
                      <td>English<br>Mrs.A B<br>Room c4-9</td>
                      <td>TLE<br>Sra.Angela Angel<br>Room c4-12</td>
                      <td>TLE<br>Sra.Angela Angel<br>Room c4-12</td>
                      <td>TLE<br>Sra.Angela Angel<br>Room c4-12</td>
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                              <th class="text-center">Grado 3-A</th>
                 <th class = "text-center"> Lunes </th>
                    <th class = "text-center"> Martes </th>
                    <th class = "text-center"> Miercoles </th>
                    <th class = "text-center"> jueves </th>
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                           <th class="text-center">Grado 3-B</th>
                 <th class = "text-center"> Lunes </th>
                    <th class = "text-center"> Martes </th>
                    <th class = "text-center"> Miercoles </th>
                    <th class = "text-center"> jueves </th>
