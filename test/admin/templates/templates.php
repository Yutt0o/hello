...
<?php function navbar($active){?>
        ...
        <!-- Logo -->
        <a href="dashboard.php" class="logo"><i class="glyphicon glyphicon-home"></i> Administrador</a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-body">
                    <div class="col-xs-4 text-center">
                      <a href="username.php">Cambie el nombre de usuario</a>
                    </div>
                    <div class="col-xs-4 text-center pull-right">
                      <a href="password.php">Cambia la contraseña</a>
                    </div>
                  </li>
                </ul>
              </li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            ?>
              <a href="subjects.php">
                <i class="glyphicon glyphicon-th-list"></i> <span>Asignaturas</span>
              </a>
            </li>
            ...
            ?>
              <a href="yearlevel.php">
                <i class="glyphicon glyphicon-th-list"></i> <span>Nivel de año</span>
              </a>
            </li>
            ...
            ?>
              <a href="subjectyear.php">
                <i class="glyphicon glyphicon-list-alt"></i> <span>Agregar sujeto al nivel del año</span>
              </a>
            </li>
            ...
            ?>
              <a href="teachers.php">
                <i class="glyphicon glyphicon-folder-open"></i> <span>Perfil docente</span>
              </a>
            </li>
            ...
            ?>
              <a href="students.php">
                <i class="glyphicon glyphicon-folder-open"></i> <span>Perfil de los estudiantes</span>
              </a>
            </li>
            ...
            ?>
              <a href="enroll.php">
                <i class="glyphicon glyphicon-list-alt"></i> <span>Inscribir estudiantes</span>
              </a>
            </li>
            ...
            ?>
              <a href="subjectschedule.php">
                <i class="glyphicon glyphicon-book"></i> <span>Asunto Horario</span>
              </a>
            </li>
            ...
            ?>
              <a href="teacherschedule.php">
                <i class="glyphicon glyphicon-book"></i> <span>Horario del profesor</span>
              </a>
            </li>
 ...
 <?php if($active=="teacherschedule"){ 
            ...
            ?>
              <a href="https://www.codigofuentegratis.net/">
                <i class="glyphicon glyphicon-book"></i> <span>MAS codigo fuente gratis</span>
              </a>
            </li>
